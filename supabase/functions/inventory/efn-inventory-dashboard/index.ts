/**
 * inventory/efn-inventory-dashboard/index.ts
 */
...
import { getInventoryDashboard }          from "./handler.ts";
import { InventoryDashboardSchema }       from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, InventoryDashboardSchema, correlationId);
