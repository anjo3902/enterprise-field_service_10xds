/**
 * ticket/efn-ticket-assign/index.ts
 */
...
import { assignTicket }                   from "./handler.ts";
import { AssignTicketSchema }             from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, AssignTicketSchema, correlationId);
