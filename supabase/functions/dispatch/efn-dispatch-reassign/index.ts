/**
 * dispatch/efn-dispatch-reassign/index.ts
 */
...
import { dispatchReassign }               from "./handler.ts";
import { DispatchReassignSchema }         from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, DispatchReassignSchema, correlationId);

    const result = await dispatchReassign(
