/**
 * asset/efn-asset-search/index.ts
 */
...
import { searchAssets }                   from "./handler.ts";
import { AssetSearchSchema }              from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, AssetSearchSchema, correlationId);
