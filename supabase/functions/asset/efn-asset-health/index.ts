/**
 * asset/efn-asset-health/index.ts
 */
...
import { getAssetHealth }                 from "./handler.ts";
import { GetAssetHealthSchema }           from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, GetAssetHealthSchema, correlationId);
