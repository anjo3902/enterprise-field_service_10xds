/**
 * workorder/efn-wo-status/index.ts
 */
...
import { transitionWoStatus }             from "./handler.ts";
import { WoStatusSchema }                 from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, WoStatusSchema, correlationId);

    const result = await transitionWoStatus(
