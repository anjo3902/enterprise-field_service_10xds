/**
 * workorder/efn-wo-checklist/index.ts
 */
...
import { handleChecklist }                from "./handler.ts";
import { ChecklistActionSchema }          from "./schema.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = await parseBody(req, ChecklistActionSchema, correlationId);

    const result = await handleChecklist(
